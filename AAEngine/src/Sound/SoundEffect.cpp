...
//static std::vector<ALuint> g_SoundEffectBuffers;
...
//	}
//
//	g_SoundEffectBuffers.push_back(buffer);  // add to the list of known buffers
//
//	return buffer;
//}
//
//bool SoundEffect::RemoveSoundEffect(const ALuint& buf_to_remove) {
//	auto it = g_SoundEffectBuffers.begin();
//	while (it != g_SoundEffectBuffers.end())
//	{
//		if (*it == buf_to_remove)
//		{
//			alDeleteBuffers(1, &*it);
//
//			it = g_SoundEffectBuffers.erase(it);
//
...
//void SoundEffect::DestroyAllBuffers() {
//	for (auto& b : g_SoundEffectBuffers)
//	{
//		alDeleteBuffers(1, &b);
//	}
//	g_SoundEffectBuffers.clear();
//}
