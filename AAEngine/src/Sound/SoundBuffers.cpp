#include "../../include/Sound/SoundBuffers.h"
#include <sndfile.h>
#include <inttypes.h>
#include <AL\alext.h>

namespace AA{
SoundBuffers* SoundBuffers::get()
{
	static SoundBuffers* sndbuf = new SoundBuffers();
	return sndbuf;
}
...
SoundBuffers::~SoundBuffers()
{
	alDeleteBuffers(buffers.size(), buffers.data());  // remove all with 1 call
	buffers.clear(); //probably not necessary but whatevs
}
}  // end namespace AA