/* Tests a first person world with 3 lights. 
   Test Randomization Library
*/

#pragma once
#include "dry/LoadableAssets.h"
...
{
  LoadableAssets objs;
  objs.loadConfig("../TestBench/config/models.txt");
 
  AAWorld engine;

  DISPLAY->setWindowTitle("AA Demo 1 (Randomization) - Close Window To Continue");

  std::cout << "random 1d3: " << mearly::Random::NTKR(1, 3) <<'\n';
