...
int main()
{
	...
	LOOP->getGameObject(go_ship).scaleTo(glm::vec3(.6f));
	...
	LOOP->getGameObject(go_lazer).translateTo(glm::vec3(0, -16, 0));
	LOOP->getGameObject(go_lazer).scaleTo(glm::vec3(.5f));
