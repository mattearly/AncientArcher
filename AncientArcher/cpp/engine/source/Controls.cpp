...
void Controls::mouseMovement(float xpos, float ypos, Camera *cam, ControlType type) {
...
void Controls::playerKeyboardInput(ControlType type)
{
  switch (type)
  {
  case ControlType::FPS:
