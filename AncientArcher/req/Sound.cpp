...
void initsound() {
  ...
  footstepsoundeffects[0] = Mix_LoadWAV("footstep01.wav");  // load footsteps
  footstepsoundeffects[1] = Mix_LoadWAV("footstep02.wav");  // load footsteps
  footstepsoundeffects[2] = Mix_LoadWAV("footstep03.wav");  // load footsteps
  footstepsoundeffects[3] = Mix_LoadWAV("footstep04.wav");  // load footsteps
  footstepsoundeffects[4] = Mix_LoadWAV("footstep05.wav");  // load footsteps
  footstepsoundeffects[5] = Mix_LoadWAV("footstep06.wav");  // load footsteps
  ...
  gruntsoundeffects[0] = Mix_LoadWAV("grunt01.wav");  // load grunts
  gruntsoundeffects[1] = Mix_LoadWAV("grunt02.wav");
  gruntsoundeffects[2] = Mix_LoadWAV("grunt03.wav");
  gruntsoundeffects[3] = Mix_LoadWAV("grunt04.wav");
